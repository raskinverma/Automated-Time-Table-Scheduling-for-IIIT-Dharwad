...
class Scheduler:
    ...
    def generate_timetable(self, courses_to_allocate, writer, sheet_name):
        ...
        return elective_info  # return elective details for legend
    ...
    def format_excel(self, filename, all_electives_info):
        ...
        wb.save(filename)
        print(f"Formatted timetable with borders, colors, and grouped electives saved in {filename}")
